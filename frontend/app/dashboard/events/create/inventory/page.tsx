...
import { HackathonInventory } from "@/components/inventory/HackathonInventory"
import { OtherInventory } from "@/components/inventory/OtherInventory"
import {
...
export default function CreateEventInventoryPage() {
  ...
  const showWorkshopCapacity = ['conference', 'workshop', 'corporate event', 'other'].includes(category.toLowerCase())
  const showAccommodation = ['hackathon', 'conference', 'corporate event', 'other'].includes(category.toLowerCase())
  ...
  const handleNext = () => {
    ...
    if (isHackathon) {
      inventoryPayload = hackathonData
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        {/* Hackathon */}
        {isHackathon && (
          <HackathonInventory onDataChange={setHackathonData} />
        )}
        ...
        {/* Other */}
        {isOther && (
          <OtherInventory onDataChange={setOtherData} />
        )}

        {/* ── Generic (Hackathon / Workshop / Other / etc.) ── */}
        {!isConference && !isWedding && !isHackathon && !isFestival && !isCorporateEvent && (
          <>
            {/* Global Capacity */}
            <Card>
              <CardHeader>
